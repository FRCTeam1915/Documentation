...
1. Ensure the laser hood is properly closed and the machine is powered on
2. Load the material to be cut onto the cutting bed
3. Adjust the Z-height using the control panel for optimal cutting depth
4. Set appropriate power and speed settings in the software
5. Position the laser head over the material
6. Begin the cutting process through the software interface
7. Monitor the cutting process to ensure proper operation
8. After completion, turn off the machine and clean the cutting bed
9. Regularly check and clean the laser lens and mirrors for optimal performance
...
- Z/U buttons to move the laser head up or down
